...
# Auto_Rig 包目录，所有资源路径由此派生，便于整体迁移
PACKAGE_DIR = os.path.dirname(os.path.abspath(__file__))
CTRLS_LIB_DIR = os.path.join(PACKAGE_DIR, 'ctrls_lib')
PRE_JOINTS_DIR = os.path.join(PACKAGE_DIR, 'pre_joints')
REBUILD_FILE = os.path.join(PACKAGE_DIR, 'jnt_rebuild', 'bipe.mb')
